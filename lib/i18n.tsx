...
export const TRANSLATIONS: Record<Locale, Dictionary> = {
  de: {
    ...
    'common.confirm': 'Bestätigen',
        'tool.confirmSummary': 'Soll ich Folgendes durchführen?',
    'tool.confirm': 'Bestätigen',
    'tool.cancel': 'Abbrechen',
    'tool.confirmed': 'Bestätigt und durchgeführt',
    'tool.cancelled': 'Abgebrochen',
    'knowledge.title': 'Pflegewissen',
    'knowledge.question': 'Frage',
    'knowledge.searching': 'Suche in vertrauenswürdigen Quellen…',
    'knowledge.sources': 'Quellen',
    'knowledge.trusted': 'Vertrauenswürdige Quelle',
    'knowledge.general': 'Allgemeine Quelle',
    'knowledge.disclaimer': 'Diese Antwort wurde von KI zusammengefasst und ersetzt keine fachliche oder ärztliche Beratung.',
    'headset.active': 'Headset',
    'headset.activeHint': 'Headset Play/Pause-Taste steuert den Sprach-Button',
    'settings.headset.title': 'Headset-Steuerung',
    'settings.headset.desc': 'Mit der Play/Pause-Taste auf deinen Kopfhörern oder Headset die Aufnahme starten und stoppen.',
    'settings.headset.on': 'Aktiviert',
    'settings.headset.off': 'Deaktiviert',
    ...
    'systemEvent.translatorStarted': 'Übersetzungsmodus zu {language} gestartet',
    'systemEvent.translatorStopped': 'Übersetzungsmodus beendet ({language})',
    'systemEvent.showDetails': 'Details',
    'headset.controlPossible': 'Headset-Steuerung möglich',
    'headset.unknownHint': 'Hook ist aktiv - Gerät nicht eindeutig erkannt',
    'settings.headset.deviceConnected': '{name} verbunden',
    'settings.headset.noDevice': 'Kein Headset verbunden - Steuerung aktiviert sich automatisch beim Einstecken',
'common.close': 'Schließen',
  ...
  en: {
    ...
    'common.confirm': 'Confirm',
        'tool.confirmSummary': 'Should I do the following?',
    'tool.confirm': 'Confirm',
    'tool.cancel': 'Cancel',
    'tool.confirmed': 'Confirmed and executed',
    'tool.cancelled': 'Cancelled',
    'knowledge.title': 'Care knowledge',
    'knowledge.question': 'Question',
    'knowledge.searching': 'Searching trusted sources…',
    'knowledge.sources': 'Sources',
    'knowledge.trusted': 'Trusted source',
    'knowledge.general': 'General source',
    'knowledge.disclaimer': 'This answer was summarized by AI and does not replace professional or medical advice.',
    'headset.active': 'Headset',
    'headset.activeHint': 'Headset Play/Pause button controls the voice button',
    'settings.headset.title': 'Headset Control',
    'settings.headset.desc': 'Use the Play/Pause button on your headphones or headset to start and stop recording.',
    'settings.headset.on': 'Enabled',
    'settings.headset.off': 'Disabled',
    ...
    'systemEvent.translatorStarted': 'Translation mode started ({language})',
    'systemEvent.translatorStopped': 'Translation mode ended ({language})',
    'systemEvent.showDetails': 'Details',
    'headset.controlPossible': 'Headset control possible',
    'headset.unknownHint': 'Hook active - device not clearly detected',
    'settings.headset.deviceConnected': '{name} connected',
    'settings.headset.noDevice': 'No headset connected - control activates automatically when plugged in',
'common.close': 'Close',
  },
  ...
  it: {
    ...
    'common.confirm': 'Conferma',
        'tool.confirmSummary': 'Devo eseguire quanto segue?',
    'tool.confirm': 'Conferma',
    'tool.cancel': 'Annulla',
    'tool.confirmed': 'Confermato ed eseguito',
    'tool.cancelled': 'Annullato',
    'knowledge.title': 'Conoscenza assistenziale',
    'knowledge.question': 'Domanda',
    'knowledge.searching': 'Ricerca in fonti attendibili…',
    'knowledge.sources': 'Fonti',
    'knowledge.trusted': 'Fonte attendibile',
    'knowledge.general': 'Fonte generale',
    'knowledge.disclaimer': 'Questa risposta è stata riassunta dall\'IA e non sostituisce una consulenza professionale o medica.',
    'headset.active': 'Cuffie',
    'headset.activeHint': 'Il tasto Play/Pausa delle cuffie controlla il pulsante vocale',
    'settings.headset.title': 'Controllo cuffie',
    'settings.headset.desc': 'Usa il tasto Play/Pausa di cuffie o auricolari per avviare e fermare la registrazione.',
    'settings.headset.on': 'Attivato',
    'settings.headset.off': 'Disattivato',
    ...
    'systemEvent.translatorStarted': 'Modalità traduzione avviata ({language})',
    'systemEvent.translatorStopped': 'Modalità traduzione terminata ({language})',
    'systemEvent.showDetails': 'Dettagli',
    'headset.controlPossible': 'Controllo cuffie possibile',
    'headset.unknownHint': 'Hook attivo - dispositivo non rilevato chiaramente',
    'settings.headset.deviceConnected': '{name} collegate',
    'settings.headset.noDevice': 'Nessuna cuffia collegata - il controllo si attiva automaticamente al collegamento',
'common.close': 'Chiudi',
  },
  ...
  fr: {
    ...
    'common.confirm': 'Confirmer',
        'tool.confirmSummary': 'Dois-je effectuer ce qui suit ?',
    'tool.confirm': 'Confirmer',
    'tool.cancel': 'Annuler',
    'tool.confirmed': 'Confirmé et exécuté',
    'tool.cancelled': 'Annulé',
    'knowledge.title': 'Connaissances en soins',
    'knowledge.question': 'Question',
    'knowledge.searching': 'Recherche dans des sources fiables…',
    'knowledge.sources': 'Sources',
    'knowledge.trusted': 'Source fiable',
    'knowledge.general': 'Source générale',
    'knowledge.disclaimer': 'Cette réponse a été résumée par l\'IA et ne remplace pas un avis professionnel ou médical.',
    'headset.active': 'Casque',
    'headset.activeHint': 'La touche Lecture/Pause du casque contrôle le bouton vocal',
    'settings.headset.title': 'Contrôle du casque',
    'settings.headset.desc': 'Utilise le bouton Lecture/Pause de tes écouteurs ou de ton casque pour démarrer et arrêter l\'enregistrement.',
    'settings.headset.on': 'Activé',
    'settings.headset.off': 'Désactivé',
    ...
    'systemEvent.translatorStarted': 'Mode traduction démarré ({language})',
    'systemEvent.translatorStopped': 'Mode traduction terminé ({language})',
    'systemEvent.showDetails': 'Détails',
    'headset.controlPossible': 'Contrôle du casque possible',
    'headset.unknownHint': 'Hook actif - appareil non clairement détecté',
    'settings.headset.deviceConnected': '{name} connecté',
    'settings.headset.noDevice': 'Aucun casque connecté - le contrôle s\'active automatiquement à la connexion',
'common.close': 'Fermer',
  },
  ...
  es: {
    ...
    'common.confirm': 'Confirmar',
        'tool.confirmSummary': '¿Debo realizar lo siguiente?',
    'tool.confirm': 'Confirmar',
    'tool.cancel': 'Cancelar',
    'tool.confirmed': 'Confirmado y ejecutado',
    'tool.cancelled': 'Cancelado',
    'knowledge.title': 'Conocimiento asistencial',
    'knowledge.question': 'Pregunta',
    'knowledge.searching': 'Buscando en fuentes confiables…',
    'knowledge.sources': 'Fuentes',
    'knowledge.trusted': 'Fuente confiable',
    'knowledge.general': 'Fuente general',
    'knowledge.disclaimer': 'Esta respuesta fue resumida por IA y no sustituye el asesoramiento profesional o médico.',
    'headset.active': 'Auriculares',
    'headset.activeHint': 'El botón Play/Pausa de los auriculares controla el botón de voz',
    'settings.headset.title': 'Control de auriculares',
    'settings.headset.desc': 'Usa el botón Play/Pausa de tus auriculares o headset para iniciar y detener la grabación.',
    'settings.headset.on': 'Activado',
    'settings.headset.off': 'Desactivado',
    ...
    'systemEvent.translatorStarted': 'Modo de traducción iniciado ({language})',
    'systemEvent.translatorStopped': 'Modo de traducción terminado ({language})',
    'systemEvent.showDetails': 'Detalles',
    'headset.controlPossible': 'Control de auriculares posible',
    'headset.unknownHint': 'Hook activo - dispositivo no detectado claramente',
    'settings.headset.deviceConnected': '{name} conectado',
    'settings.headset.noDevice': 'Sin auriculares conectados - el control se activa automáticamente al conectar',
'common.close': 'Cerrar',
  },
};
